...
// BOT結果の統合1パネル `BotRecommended` は T-1300 で
// docs/archive/bot/ui/components/matchup/BotRecommended.tsx へ退避した（復活の判断は T-1308）。
// 上の非公開ヘルパー（spellName / CoreRow / BootsRow / SituationalRow / RowLabel）を共有していたため、
// 復活時はこのファイルへ戻して export を足すこと。
